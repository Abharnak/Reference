...
3. Use Column(column in use) from created table in matrix view eg
<img width="238" height="249" alt="image" src="https://github.com/user-attachments/assets/320fb351-b338-4dab-af90-5ea3047311e4" />
4. In Data Pane, Click on Column(column in use) and sort by Column click order.
5. If need to change font color or back ground use separate measure for modifying that use that measure in cell elements field in visualization pane
